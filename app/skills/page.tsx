  ...
  const isDark = theme === "dark";
   ...
   const skillCategories = [
    ...
    },
    {
      ...
      skills: ["Node.js", "Express", "REST API", "Authentication", "JWT", "Flask",],
    },
    {
      title: "Database",
      ...
      skills: ["MongoDB", "PostgreSQL", "Redis", "Prisma", "MySQL", "SQLite", "Drizzle ORM"],
    },
    {
      ...
      skills: ["Docker", "Azure", "Grafana","Prometheus"],
    },
    {
    ...
    },
    {
      ...
      skills: ["Git", "Linux", "Postman", "Bruno"],
    },
  ]
